Shader "Unlit/Liquid"
{
    Properties
    {
      ...
      _LiquidMidAmount ("Liquid Mid Amount", Range(0, 0.2)) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                fixed4 midEdge = step(i.liquidEdge,0.5) - smoothstep(i.liquidEdge, 0.5, (0.5 - _LiquidMidAmount));
